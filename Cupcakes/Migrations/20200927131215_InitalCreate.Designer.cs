...
namespace Cupcakes.Migrations
{
    ...
    [Migration("20200927131215_InitalCreate")]
            ...
            modelBuilder.Entity("Cupcakes.Models.Bakery", b =>
                {
                    ...
                    b.HasData(
                        new { BakeryId = 1, BakeryName = "Gluteus Free", Quantity = 8 },
                        new { BakeryId = 2, BakeryName = "Cupcakes Break", Quantity = 22 },
                        new { BakeryId = 3, BakeryName = "Cupcakes Ahead", Quantity = 18 },
                        new { BakeryId = 4, BakeryName = "Sugar", Quantity = 30 }
                    );
                });
