...
namespace PollBall
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<IPollResultSevice, PollResultSevice>();
            services.AddMvc();

        }

        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IPollResultSevice pollResults)
        {
